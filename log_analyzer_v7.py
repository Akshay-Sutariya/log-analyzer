...
receiver_email = "receiver123@gmail.com"
	...
	for ip, count in ip_counter.most_common(top):
		...
		if count >= THRESHOLD:
			...
			if ip not in blocked_ips:
				...
				save_blocked_ip(ip) # Save blocked ip in file
				action = "Blocked"
			else:
		...
		result.append([ip, count, country, action])
	print(table)
